...
DEPS=(nmap nikto sqlmap metasploit-framework burpsuite python3-tk testssl.sh theharvester subfinder whatweb nuclei chromium)
...
echo "[+] Checking tools..."
for tool in nmap nikto sqlmap msfconsole burpsuite testssl theHarvester subfinder whatweb nuclei chromium; do
